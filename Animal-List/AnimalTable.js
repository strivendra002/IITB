...
class AnimalCards {
  ...
  addSearchFunctionality() {
    ...
    searchInput.addEventListener('input', () => {
        ...
        const filteredData = this.data.filter(animal => 
...
const bigCatsData = [
  ...
  },
  {
    ...
    Size: "8 ft",
    Location: "Africa",
    ImageUrl: "https://2.bp.blogspot.com/-xUhDTeNaeCY/UWk0hyEf0rI/AAAAAAAAAFk/kp79USw5ubE/s1600/Wild-Lion.jpg",
  },
  {
    Species: "Big Cats",
    Name: "Leopard",
    ...
    ImageUrl: "https://upload.wikimedia.org/wikipedia/commons/0/0c/Amur_Leopard_(1970226951).jpg",
  },
];
